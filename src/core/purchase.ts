 ...
 *  own = "소장". '평생' 워딩은 전면 금지 — 서비스 무기한 보장을 약속하는 말이라 부채가 되고
 *  소비자도 반신반의한다. 제공기간 표기(2026-08-14 토스PG 12개월 정책 대응): 유료 제공기간 =
 *  결제일부터 12개월 + 이후 서비스가 제공되는 동안 무상 연장(정본 refund.html 10절 — entitlements의
 *  own은 여전히 만료 없음(expires_at null), 12개월은 "환불 채무 범위"지 이용권 만료가 아니다).
