...
const ICONS: Record<string, IconDef> = {
  ...
  // 불꽃 — 또렷한 실루엣 + 밝은 심지 구멍(evenodd). 스트릭 칩이 15px로 쓰므로 소용돌이형 금지(사용자 확정 2026-07-16).
  flame: { v: '<path fill-rule="evenodd" d="M12 1.8c1.1 3.2 3.1 5.1 4.7 7.1 1.5 1.9 2.3 3.7 2.3 5.7 0 4-3.1 7.2-7 7.2s-7-3.2-7-7.2c0-2 .8-3.8 2.3-5.7C8.9 6.9 10.9 5 12 1.8z M12 11c.7 1.5 1.9 2.4 1.9 4 0 1.4-.85 2.4-1.9 2.4s-1.9-1-1.9-2.4c0-1.6 1.2-2.5 1.9-4z"/>', fill: true },
  ...
  monitor: { v: '<rect x="3" y="4.5" width="18" height="13" rx="2.5"/><path d="M9 20.5h6M12 17.5v3"/>', sw: 2 },
  ...
  // 발자국 2개 지그재그(왼발 미러 + 좌우 스플레이) — 트레일 도장(#bsfp)의 아이콘판(사용자 확정 2026-07-16: 한 짝 금지).
  footstep: { v: '<g transform="translate(7.6 16.4) rotate(-8) scale(-1.3,1.3)"><path d="M0,-5.6 C1.8,-5.6 3.2,-4.4 3.2,-2.6 C3.2,-0.8 2.5,0.8 1.7,1.4 C1.2,1.8 -1.2,1.8 -1.7,1.4 C-2.5,0.8 -3.2,-0.8 -3.2,-2.6 C-3.2,-4.4 -1.8,-5.6 0,-5.6 Z"/><rect x="-2" y="2.9" width="4" height="2.7" rx="1.35"/></g><g transform="translate(16.4 7.6) rotate(8) scale(1.3)"><path d="M0,-5.6 C1.8,-5.6 3.2,-4.4 3.2,-2.6 C3.2,-0.8 2.5,0.8 1.7,1.4 C1.2,1.8 -1.2,1.8 -1.7,1.4 C-2.5,0.8 -3.2,-0.8 -3.2,-2.6 C-3.2,-4.4 -1.8,-5.6 0,-5.6 Z"/><rect x="-2" y="2.9" width="4" height="2.7" rx="1.35"/></g>', fill: true },
