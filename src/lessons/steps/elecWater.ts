// elecWater — 전류·전압 물 비유 랩 **2D 원본**(중2 VII L3, 책 248~249쪽 그림 VII-5). 가로 모드.
//   ※ 2026-07-26부터 L3는 3D판 `elecWater3d.ts`(waterCircuit3d)를 쓴다. 이 파일은 **원본 보존용**으로
//     registry·dsl에 그대로 등록돼 있다 — content/g2/unit7.ts의 팩토리를 waterCircuit(...)로 되돌리면 즉시 복귀.
