...
const MACS: Mac[] = [
  {
    ...
    inputs: [2, 5, 8],
    out: (x) => [x + 3],
    q: "검사 끝! 이 기계, 넣는 수 <i class='mv'>x</i>를 정하면 나오는 수 <i class='mv'>y</i>도 <b>하나로 딱 정해지나요</b>?",
    items: [
      {
  ...
  },
  {
    ...
    q: "1에서는 하나였는데 6에서는 넷이 우르르! <i class='mv'>y</i>가 <b>하나로 딱 정해진다</b>고 할 수 있을까요?",
    items: [
      {
  ...
  },
  {
    ...
    inputs: [1, 7, 100],
    out: () => [5],
    q: "뭘 넣어도 5만 나와요. 이 기계는 <i class='mv'>y</i>가 <b>하나로 딱 정해지는</b> 기계일까요?",
    items: [
      {
