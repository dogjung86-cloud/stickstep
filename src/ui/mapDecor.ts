...
const MAP_DECOR: Record<string, string> = {
  ...
  // ── 사회 Ⅶ. 인간과 사회생활 — "사회 속 나" 여정(요람 → 책가방 → 이름표 → 엉킨 덩굴 → 악수) ──
  socCradleDeco: S(
    `${shadow(32, 56, 17, 0.13)}
    <path d="M12 30q20-10 40 0l-3 16q-17 8-34 0z" fill="url(#s7d-cradle)" stroke="#7A4E1E" stroke-width="1.7" stroke-linejoin="round"/>
    <path d="M16 33q16-7 32 0" stroke="#A87838" stroke-width="1.3" opacity=".7" fill="none"/>
    <path d="M15 46q4 8 10 9M49 46q-4 8-10 9" stroke="#7A4E1E" stroke-width="2" stroke-linecap="round" fill="none"/>
    <circle cx="32" cy="27" r="6.5" fill="url(#s7d-babyface)" stroke="#C09A5E" stroke-width="1.3"/>
    <circle cx="29.8" cy="26" r=".9" fill="#3A2810"/><circle cx="34.2" cy="26" r=".9" fill="#3A2810"/>
    <path d="M30 29.4q2 1.4 4 0" stroke="#3A2810" stroke-width="1.1" stroke-linecap="round" fill="none"/>
    <path d="M20 18q2-4 6-4M44 18q-2-4-6-4" stroke="#B8C8E8" stroke-width="1.6" stroke-linecap="round" fill="none" opacity=".9"/>
    <ellipse cx="22" cy="33" rx="5" ry="2" fill="#fff" opacity=".3" transform="rotate(-14 22 33)"/>`,
    `<linearGradient id="s7d-cradle" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#D9A76C"/><stop offset=".55" stop-color="#B67F42"/><stop offset="1" stop-color="#8E5D2A"/></linearGradient>
    <radialGradient id="s7d-babyface" cx=".4" cy=".35" r=".85"><stop offset="0" stop-color="#FDEBD2"/><stop offset="1" stop-color="#EBCB9E"/></radialGradient>`,
  ),
  socBagDeco: S(
    `${shadow(32, 57, 15, 0.13)}
    <rect x="16" y="20" width="32" height="34" rx="9" fill="url(#s7d-bag)" stroke="#7E2E8E" stroke-width="1.7"/>
    <path d="M22 20q10-9 20 0" stroke="#7E2E8E" stroke-width="2.4" fill="none" stroke-linecap="round"/>
    <rect x="22" y="36" width="20" height="14" rx="5" fill="url(#s7d-pocket)" stroke="#7E2E8E" stroke-width="1.4"/>
    <rect x="29" y="34" width="6" height="5" rx="2" fill="#F2C24E" stroke="#B8860E" stroke-width="1"/>
    <path d="M20 27h24" stroke="#B77CC8" stroke-width="1.4" opacity=".8"/>
    <ellipse cx="24" cy="25" rx="4.6" ry="1.8" fill="#fff" opacity=".32" transform="rotate(-18 24 25)"/>`,
    `<linearGradient id="s7d-bag" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#C888E2"/><stop offset=".55" stop-color="#A050C2"/><stop offset="1" stop-color="#7E2E9E"/></linearGradient>
    <linearGradient id="s7d-pocket" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#E8D2F2"/><stop offset="1" stop-color="#CBA0DE"/></linearGradient>`,
  ),
  socNametagDeco: S(
    `${shadow(32, 56, 16, 0.13)}
    <g transform="rotate(-6 32 36)">
      <rect x="12" y="24" width="40" height="24" rx="7" fill="url(#s7d-tag)" stroke="#B8860E" stroke-width="1.7"/>
      <circle cx="20" cy="36" r="3" fill="#FFFFFF" stroke="#B8860E" stroke-width="1.4"/>
      <path d="M28 32h18M28 40h12" stroke="#8A6A2E" stroke-width="2.2" stroke-linecap="round" opacity=".75"/>
      <path d="M20 24v-6q0-4 6-4" stroke="#8A93A6" stroke-width="1.8" fill="none" stroke-linecap="round"/>
      <ellipse cx="20" cy="28" rx="5" ry="1.8" fill="#fff" opacity=".38" transform="rotate(-10 20 28)"/>
    </g>`,
    `<linearGradient id="s7d-tag" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#FCE9B8"/><stop offset=".55" stop-color="#F2C96E"/><stop offset="1" stop-color="#D9A63E"/></linearGradient>`,
  ),
  socVineDeco: S(
    `${shadow(32, 57, 14, 0.13)}
    <rect x="29" y="12" width="6" height="44" rx="3" fill="url(#s7d-pole)" stroke="#5E4322" stroke-width="1.4"/>
    <path d="M14 54q16-8 14-22t8-16" stroke="url(#s7d-vine1)" stroke-width="3" fill="none" stroke-linecap="round"/>
    <path d="M50 54q-16-8-14-22t-8-16" stroke="url(#s7d-vine2)" stroke-width="3" fill="none" stroke-linecap="round"/>
    <ellipse cx="20" cy="44" rx="3.6" ry="2" fill="#3FA764" transform="rotate(-30 20 44)"/>
    <ellipse cx="44" cy="44" rx="3.6" ry="2" fill="#8A6BD0" transform="rotate(30 44 44)"/>
    <circle cx="32" cy="30" r="7" fill="none" stroke="#E8590C" stroke-width="2" stroke-dasharray="3.2 3.2"/>`,
    `<linearGradient id="s7d-pole" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#B98D54"/><stop offset=".5" stop-color="#96682F"/><stop offset="1" stop-color="#6E4A1E"/></linearGradient>
    <linearGradient id="s7d-vine1" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#4CB878"/><stop offset="1" stop-color="#2E7E46"/></linearGradient>
    <linearGradient id="s7d-vine2" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#9E7EE0"/><stop offset="1" stop-color="#6E4FB8"/></linearGradient>`,
  ),
  socShakeDeco: S(
    `${shadow(32, 56, 17, 0.12)}
    <path d="M8 40q10-10 18-5M56 40q-10-10-18-5" stroke="#8A93A6" stroke-width="2.6" stroke-linecap="round" fill="none"/>
    <g transform="rotate(-8 32 36)">
      <rect x="22" y="30" width="20" height="13" rx="6.5" fill="url(#s7d-hands)" stroke="#B8860E" stroke-width="1.6"/>
      <path d="M26 33.5h12M26 37h12M26 40h9" stroke="#B8860E" stroke-width="1.1" opacity=".55"/>
    </g>
    <path d="M30 20l1.6 3.6L35 25l-3.4 1.4L30 30l-1.6-3.6L25 25l3.4-1.4zM44 16l1 2.4 2.6 1-2.6 1-1 2.4-1-2.4-2.6-1 2.6-1z" fill="#F2C24E"/>
    <ellipse cx="27" cy="32.5" rx="4.4" ry="1.6" fill="#fff" opacity=".4" transform="rotate(-12 27 32.5)"/>`,
    `<linearGradient id="s7d-hands" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#FCE0A8"/><stop offset=".55" stop-color="#F2C070"/><stop offset="1" stop-color="#D99E42"/></linearGradient>`,
  ),

  // ── 사회 Ⅷ. 다양한 문화의 이해 — "문화를 발견하고 바르게 보는 눈"(밥상 → 장독 → 폰 → 탈 → 안경) ──
  socBowlDeco: S(
    `${shadow(32, 56, 17, 0.13)}
    <ellipse cx="32" cy="50" rx="22" ry="4" fill="url(#s8d-mat)" opacity=".9"/>
    <path d="M16 36q0 12 16 12t16-12z" fill="url(#s8d-bowl)" stroke="#8A4A22" stroke-width="1.7"/>
    <ellipse cx="32" cy="36" rx="16" ry="4.6" fill="#FDF3E4" stroke="#8A4A22" stroke-width="1.4"/>
    <ellipse cx="32" cy="35.4" rx="12" ry="3" fill="#F8FAFC"/>
    <path d="M27 33q3-2 7-1M36 34q2-1 4 0" stroke="#E2E8F2" stroke-width="1.4" stroke-linecap="round" fill="none"/>
    <path d="M14 18v14M11 18v5M17 18v5M11 23q3 2 6 0" stroke="#7E6A4E" stroke-width="1.8" stroke-linecap="round" fill="none"/>
    <path d="M50 18v14M47 18l1.4 6M53 18l-1.4 6" stroke="#7E6A4E" stroke-width="1.8" stroke-linecap="round" fill="none"/>
    <ellipse cx="25" cy="40" rx="4.6" ry="1.8" fill="#fff" opacity=".35" transform="rotate(-12 25 40)"/>`,
    `<linearGradient id="s8d-bowl" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#E2925A"/><stop offset=".55" stop-color="#C26A34"/><stop offset="1" stop-color="#96481E"/></linearGradient>
    <linearGradient id="s8d-mat" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#EADFC8"/><stop offset="1" stop-color="#D2C0A0"/></linearGradient>`,
  ),
  socJarDeco: S(
    `${shadow(32, 57, 16, 0.13)}
    <path d="M24 16h16l3 6q5 8 5 16 0 14-16 14T16 38q0-8 5-16z" fill="url(#s8d-jar)" stroke="#5E3A1E" stroke-width="1.7" stroke-linejoin="round"/>
    <ellipse cx="32" cy="16" rx="8" ry="2.8" fill="url(#s8d-jarlid)" stroke="#5E3A1E" stroke-width="1.4"/>
    <path d="M20 30q12 5 24 0M18 40q14 5 28 0" stroke="#4E2E12" stroke-width="1.3" opacity=".45" fill="none"/>
    <path d="M27 22q-4 3-5 8" stroke="#fff" stroke-width="2.2" stroke-linecap="round" opacity=".4" fill="none"/>
    <path d="M40 46l2.4 5.4M44 44l3.2 4.4" stroke="#C24A2E" stroke-width="2.2" stroke-linecap="round" opacity=".85"/>
    <ellipse cx="24" cy="26" rx="4.4" ry="1.8" fill="#fff" opacity=".32" transform="rotate(-24 24 26)"/>`,
    `<linearGradient id="s8d-jar" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#A9744A"/><stop offset=".55" stop-color="#84522C"/><stop offset="1" stop-color="#5E3A1E"/></linearGradient>
    <linearGradient id="s8d-jarlid" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#B98A5E"/><stop offset="1" stop-color="#7E5230"/></linearGradient>`,
  ),
  socPhoneDeco: S(
    `${shadow(32, 57, 14, 0.13)}
    <g transform="rotate(-6 32 36)">
      <rect x="20" y="14" width="24" height="42" rx="6" fill="url(#s8d-phone)" stroke="#2E3A4E" stroke-width="1.7"/>
      <rect x="23" y="19" width="18" height="30" rx="3" fill="url(#s8d-screen)"/>
      <path d="M29 30l8 4-8 4z" fill="#FFFFFF" stroke="#1B64DA" stroke-width="1.2" stroke-linejoin="round"/>
      <circle cx="32" cy="52.5" r="1.8" fill="#8A93A6"/>
      <ellipse cx="27" cy="22" rx="4" ry="1.6" fill="#fff" opacity=".5" transform="rotate(-16 27 22)"/>
    </g>
    <path d="M48 18q4 4 0 8M52 15q6 7 0 14" stroke="#E8944E" stroke-width="2" stroke-linecap="round" fill="none"/>
    <circle cx="14" cy="24" r="2" fill="#F2C24E"/><circle cx="11" cy="31" r="1.4" fill="#E8944E"/>`,
    `<linearGradient id="s8d-phone" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#5E6A7E"/><stop offset=".55" stop-color="#3E4A5E"/><stop offset="1" stop-color="#283242"/></linearGradient>
    <linearGradient id="s8d-screen" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#BFE0FF"/><stop offset="1" stop-color="#7EB2F2"/></linearGradient>`,
  ),
  socMaskDeco: S(
    `${shadow(32, 56, 15, 0.13)}
    <g transform="rotate(-5 32 34)">
      <path d="M32 12q16 0 16 16 0 12-7 18t-9 6-9-6-7-18q0-16 16-16z" fill="url(#s8d-mask)" stroke="#8A4A1E" stroke-width="1.7"/>
      <path d="M22 26q3-3 7-1M35 25q4-2 7 1" stroke="#4E2E12" stroke-width="2" stroke-linecap="round" fill="none"/>
      <circle cx="25.5" cy="30" r="1.6" fill="#3A2810"/><circle cx="38.5" cy="30" r="1.6" fill="#3A2810"/>
      <path d="M25 42q7 6 14 0" stroke="#4E2E12" stroke-width="2.2" stroke-linecap="round" fill="none"/>
      <circle cx="22" cy="36" r="2.6" fill="#E86A5E" opacity=".75"/><circle cx="42" cy="36" r="2.6" fill="#E86A5E" opacity=".75"/>
      <ellipse cx="26" cy="18" rx="5" ry="2" fill="#fff" opacity=".35" transform="rotate(-16 26 18)"/>
    </g>
    <path d="M13 20l1.4 3 3 1.2-3 1.2-1.4 3-1.4-3-3-1.2 3-1.2zM50 14l1 2.2 2.2 1-2.2 1-1 2.2-1-2.2-2.2-1 2.2-1z" fill="#F2C24E"/>`,
    `<radialGradient id="s8d-mask" cx=".4" cy=".3" r="1"><stop offset="0" stop-color="#F5D9A8"/><stop offset=".6" stop-color="#E2B26E"/><stop offset="1" stop-color="#C28A42"/></radialGradient>`,
  ),
  socLensDeco: S(
    `${shadow(32, 56, 17, 0.12)}
    <g transform="rotate(-4 32 36)">
      <circle cx="21" cy="34" r="10.5" fill="url(#s8d-lens)" stroke="#8A4A22" stroke-width="2.4"/>
      <circle cx="43" cy="34" r="10.5" fill="url(#s8d-lens)" stroke="#8A4A22" stroke-width="2.4"/>
      <path d="M31.5 34q.5-3 1 0" stroke="#8A4A22" stroke-width="2.2" fill="none"/>
      <path d="M10.5 34q-3-2-4-5M53.5 34q3-2 4-5" stroke="#8A4A22" stroke-width="2.2" stroke-linecap="round" fill="none"/>
      <path d="M15 28q3-3 7-3M37 28q3-3 7-3" stroke="#fff" stroke-width="2" stroke-linecap="round" opacity=".7" fill="none"/>
      <path d="M40 37l2.4 2.4 4.6-5" stroke="#2E8A4C" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
    </g>`,
    `<radialGradient id="s8d-lens" cx=".38" cy=".32" r="1"><stop offset="0" stop-color="#F2FBFF"/><stop offset=".7" stop-color="#CBE8F2"/><stop offset="1" stop-color="#9EC8DA"/></radialGradient>`,
  ),

  // ── 사회 Ⅸ. 민주주의와 시민 — "함께 결정하는 기술"(말풍선 → 투표함 → 신전 기둥 → 헌법 책 → 들어 올린 손) ──
  socTalkDeco: S(
    `${shadow(32, 56, 16, 0.12)}
    <g transform="rotate(-3 24 30)">
      <path d="M10 18h26q4 0 4 4v12q0 4-4 4H22l-6 7v-7h-6q-4 0-4-4V22q0-4 4-4z" fill="url(#s9d-talkA)" stroke="#155A9C" stroke-width="1.7" stroke-linejoin="round"/>
      <path d="M15 26h16M15 31h11" stroke="#FFFFFF" stroke-width="1.8" stroke-linecap="round" opacity=".85"/>
      <ellipse cx="17" cy="21.5" rx="5" ry="1.7" fill="#fff" opacity=".45"/>
    </g>
    <g transform="rotate(3 44 40)">
      <path d="M28 32h26q4 0 4 4v11q0 4-4 4h-6v7l-6-7H28q-4 0-4-4V36q0-4 4-4z" fill="url(#s9d-talkB)" stroke="#B06A14" stroke-width="1.7" stroke-linejoin="round"/>
      <path d="M32 39h16M32 44h12" stroke="#FFFFFF" stroke-width="1.8" stroke-linecap="round" opacity=".85"/>
      <ellipse cx="34" cy="35.5" rx="5" ry="1.7" fill="#fff" opacity=".4"/>
    </g>`,
    `<linearGradient id="s9d-talkA" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#7EB2E2"/><stop offset=".55" stop-color="#4A86C8"/><stop offset="1" stop-color="#2A6AAE"/></linearGradient>
    <linearGradient id="s9d-talkB" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#F2C070"/><stop offset=".55" stop-color="#E2A048"/><stop offset="1" stop-color="#C2822A"/></linearGradient>`,
  ),
  socBallotDeco: S(
    `${shadow(32, 57, 16, 0.13)}
    <rect x="14" y="30" width="36" height="26" rx="5" fill="url(#s9d-box)" stroke="#0F4676" stroke-width="1.7"/>
    <path d="M14 39h36" stroke="#0F4676" stroke-width="1.2" opacity=".5"/>
    <rect x="24" y="27" width="16" height="4" rx="2" fill="#0F4676"/>
    <g transform="rotate(-14 32 20)">
      <rect x="25" y="12" width="14" height="18" rx="2" fill="url(#s9d-paper)" stroke="#8A93A6" stroke-width="1.4"/>
      <path d="M28 17h8M28 21h8" stroke="#A8B2C2" stroke-width="1.2" stroke-linecap="round"/>
      <circle cx="32" cy="26" r="2.2" fill="none" stroke="#1864AB" stroke-width="1.5"/>
    </g>
    <path d="M20 44l3.4 3.6 6.6-7" stroke="#FFFFFF" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round" fill="none" opacity=".9"/>
    <ellipse cx="21" cy="33.5" rx="5" ry="1.8" fill="#fff" opacity=".3"/>`,
    `<linearGradient id="s9d-box" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#4A86C8"/><stop offset=".55" stop-color="#1864AB"/><stop offset="1" stop-color="#124F86"/></linearGradient>
    <linearGradient id="s9d-paper" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#FFFFFF"/><stop offset="1" stop-color="#E4EAF2"/></linearGradient>`,
  ),
  socPillarDeco: S(
    `${shadow(32, 57, 18, 0.13)}
    <path d="M10 24 L32 12 L54 24 v5 H10z" fill="url(#s9d-pedi)" stroke="#8A7648" stroke-width="1.7" stroke-linejoin="round"/>
    <rect x="12" y="50" width="40" height="6" rx="2" fill="url(#s9d-base)" stroke="#8A7648" stroke-width="1.5"/>
    ${[19, 32, 45].map((x) => `<rect x="${x - 4}" y="30" width="8" height="19" rx="1.5" fill="url(#s9d-col)" stroke="#8A7648" stroke-width="1.4"/><path d="M${x - 1.6} 32v15M${x + 1.6} 32v15" stroke="#B8A472" stroke-width="1" opacity=".7"/>`).join("")}
    <ellipse cx="20" cy="18" rx="6" ry="2" fill="#fff" opacity=".4" transform="rotate(-18 20 18)"/>`,
    `<linearGradient id="s9d-pedi" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#F5EBD2"/><stop offset="1" stop-color="#DCC998"/></linearGradient>
    <linearGradient id="s9d-col" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#EFE3C4"/><stop offset=".5" stop-color="#E2D2A8"/><stop offset="1" stop-color="#C8B482"/></linearGradient>
    <linearGradient id="s9d-base" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#E8D9B2"/><stop offset="1" stop-color="#C2AC7C"/></linearGradient>`,
  ),
  socLawDeco: S(
    `${shadow(32, 57, 17, 0.12)}
    <g transform="rotate(-4 32 40)">
      <path d="M12 30q10-5 20 0v22q-10-5-20 0z" fill="url(#s9d-pageL)" stroke="#155A9C" stroke-width="1.6" stroke-linejoin="round"/>
      <path d="M52 30q-10-5-20 0v22q10-5 20 0z" fill="url(#s9d-pageR)" stroke="#155A9C" stroke-width="1.6" stroke-linejoin="round"/>
      <path d="M17 36q6-2.6 11 0M17 41q6-2.6 11 0M17 46q4-1.8 8 0M36 36q6-2.6 11 0M36 41q6-2.6 11 0" stroke="#7E9EC2" stroke-width="1.3" stroke-linecap="round" fill="none"/>
      <ellipse cx="20" cy="32" rx="5" ry="1.6" fill="#fff" opacity=".55"/>
    </g>
    <path d="M32 10v10M26 13.5h12" stroke="#B8860E" stroke-width="1.8" stroke-linecap="round"/>
    <path d="M26 13.5l-3.4 6.2q3.4 2.6 6.8 0zM38 13.5l3.4 6.2q-3.4 2.6-6.8 0z" fill="url(#s9d-scale)" stroke="#8A6A0E" stroke-width="1.2" stroke-linejoin="round"/>`,
    `<linearGradient id="s9d-pageL" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#EAF2FB"/><stop offset="1" stop-color="#CBDEF2"/></linearGradient>
    <linearGradient id="s9d-pageR" x1="1" y1="0" x2="0" y2="0"><stop offset="0" stop-color="#EAF2FB"/><stop offset="1" stop-color="#CBDEF2"/></linearGradient>
    <linearGradient id="s9d-scale" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#F2CE7E"/><stop offset="1" stop-color="#D0A63E"/></linearGradient>`,
  ),
  socHandsDeco: S(
    `${shadow(32, 57, 17, 0.12)}
    ${[
      { x: 18, h: 22, rot: -10, g: "A" },
      { x: 32, h: 28, rot: 0, g: "B" },
      { x: 46, h: 21, rot: 10, g: "A" },
    ].map((o) => `<g transform="rotate(${o.rot} ${o.x} 52)">
      <path d="M${o.x} 54V${54 - o.h}" stroke="url(#s9d-arm${o.g})" stroke-width="5" stroke-linecap="round"/>
      <circle cx="${o.x}" cy="${50 - o.h}" r="5.2" fill="url(#s9d-hand)" stroke="#B06A2E" stroke-width="1.4"/>
    </g>`).join("")}
    <path d="M12 16l1.5 3.2 3.2 1.3-3.2 1.3L12 25l-1.5-3.2-3.2-1.3 3.2-1.3zM50 10l1.2 2.6 2.6 1.1-2.6 1.1-1.2 2.6-1.2-2.6-2.6-1.1 2.6-1.1z" fill="#F2C24E"/>
    <circle cx="32" cy="12" r="2" fill="#4A86C8"/>`,
    `<linearGradient id="s9d-armA" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#4A86C8"/><stop offset="1" stop-color="#1864AB"/></linearGradient>
    <linearGradient id="s9d-armB" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#E2A048"/><stop offset="1" stop-color="#C2822A"/></linearGradient>
  ...
  // ── 사회 Ⅺ. 일상생활과 법 — "약속에서 법정까지"(새끼손가락 약속 → 법전 → 양팔 저울 → 법원 → 세 계단) ──
  socPinkyDeco: S(
    `${shadow(32, 56, 17, 0.13)}
    <g transform="rotate(-8 24 38)">
      <path d="M10 46q2-12 12-14 6-1 8 4 1.5 4-2 6l-7 3q-6 3-11 1z" fill="url(#s11d-handL)" stroke="#B98A48" stroke-width="1.6" stroke-linejoin="round"/>
      <path d="M27 34q4-8 6-4 1.6 3-1 7l-3 4z" fill="url(#s11d-handL)" stroke="#B98A48" stroke-width="1.5" stroke-linejoin="round"/>
    </g>
    <g transform="rotate(8 42 38)">
      <path d="M54 46q-2-12-12-14-6-1-8 4-1.5 4 2 6l7 3q6 3 11 1z" fill="url(#s11d-handR)" stroke="#B98A48" stroke-width="1.6" stroke-linejoin="round"/>
      <path d="M37 34q-4-8-6-4-1.6 3 1 7l3 4z" fill="url(#s11d-handR)" stroke="#B98A48" stroke-width="1.5" stroke-linejoin="round"/>
    </g>
    <path d="M30 32q2-3 4 0" stroke="#B98A48" stroke-width="1.8" stroke-linecap="round" fill="none"/>
    <ellipse cx="18" cy="36" rx="4.6" ry="1.8" fill="#fff" opacity=".4" transform="rotate(-18 18 36)"/>
    <path d="M28 18l1.3 2.8 2.8 1.2-2.8 1.2-1.3 2.8-1.3-2.8-2.8-1.2 2.8-1.2z" fill="#F2C24E"/>`,
    `<radialGradient id="s11d-handL" cx=".38" cy=".32" r="1"><stop offset="0" stop-color="#FCE9CE"/><stop offset="1" stop-color="#EBC694"/></radialGradient>
    <radialGradient id="s11d-handR" cx=".62" cy=".32" r="1"><stop offset="0" stop-color="#FCE9CE"/><stop offset="1" stop-color="#E8C08C"/></radialGradient>`,
  ),
  socLawbookDeco: S(
    `${shadow(32, 57, 18, 0.13)}
    <g transform="rotate(-5 32 40)">
      <path d="M14 26q18-6 36 0v26q-18-6-36 0z" fill="url(#s11d-cover)" stroke="#5A3A0C" stroke-width="1.7" stroke-linejoin="round"/>
      <path d="M14 26q18-6 36 0l-2 3q-16-5-32 0z" fill="#fff" opacity=".18"/>
      <rect x="20" y="32" width="24" height="15" rx="2.4" fill="none" stroke="#E2B45E" stroke-width="1.4"/>
      <path d="M32 35v7m-4.6-7h9.2M27.4 42q0 2 2 2t2-2m1.2 0q0 2 2 2t2-2" stroke="#E2B45E" stroke-width="1.3" stroke-linecap="round" fill="none"/>
      <path d="M14 52q18-6 36 0v3q-18-6-36 0z" fill="url(#s11d-pages)" stroke="#5A3A0C" stroke-width="1.4" stroke-linejoin="round"/>
      <ellipse cx="23" cy="27.5" rx="6" ry="1.7" fill="#fff" opacity=".4" transform="rotate(-8 23 27.5)"/>
    </g>`,
    `<linearGradient id="s11d-cover" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#B07E2E"/><stop offset=".55" stop-color="#8C5A16"/><stop offset="1" stop-color="#6E4610"/></linearGradient>
    <linearGradient id="s11d-pages" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#FDF8EE"/><stop offset="1" stop-color="#E8D9BE"/></linearGradient>`,
  ),
  socBalanceDeco: S(
    `${shadow(32, 57, 18, 0.12)}
    <rect x="20" y="52" width="24" height="4.6" rx="2.3" fill="url(#s11d-base)" stroke="#6E4610" stroke-width="1.5"/>
    <rect x="30" y="18" width="4" height="36" rx="2" fill="url(#s11d-pole)" stroke="#6E4610" stroke-width="1.4"/>
    <rect x="12" y="16" width="40" height="3.6" rx="1.8" fill="url(#s11d-beam)" stroke="#6E4610" stroke-width="1.3"/>
    <path d="M32 12l3 4h-6z" fill="url(#s11d-beam)" stroke="#6E4610" stroke-width="1.3" stroke-linejoin="round"/>
    <path d="M15 20v7M11 27h8m-8 0q0 5 4 5t4-5" fill="none" stroke="#6E4610" stroke-width="1.4"/>
    <path d="M11 27q0 5 4 5t4-5z" fill="url(#s11d-pan)"/>
    <path d="M49 20v7M45 27h8m-8 0q0 5 4 5t4-5" fill="none" stroke="#6E4610" stroke-width="1.4"/>
    <path d="M45 27q0 5 4 5t4-5z" fill="url(#s11d-pan)"/>
    <ellipse cx="26" cy="17" rx="6" ry="1.2" fill="#fff" opacity=".5"/>
    <circle cx="32" cy="12" r="1.6" fill="#F2C24E"/>`,
    `<linearGradient id="s11d-pole" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#E2B45E"/><stop offset="1" stop-color="#A8781E"/></linearGradient>
    <linearGradient id="s11d-beam" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#ECC26A"/><stop offset="1" stop-color="#A8781E"/></linearGradient>
    <linearGradient id="s11d-pan" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#D8A848"/><stop offset="1" stop-color="#8C5A16"/></linearGradient>
    <linearGradient id="s11d-base" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#B07E2E"/><stop offset="1" stop-color="#6E4610"/></linearGradient>`,
  ),
  socCourtDeco: S(
    `${shadow(32, 57, 19, 0.12)}
    <path d="M32 10L10 22h44z" fill="url(#s11d-roof)" stroke="#5A6478" stroke-width="1.6" stroke-linejoin="round"/>
    <rect x="12" y="22" width="40" height="4" rx="1.4" fill="url(#s11d-lintel)" stroke="#5A6478" stroke-width="1.3"/>
    <g fill="url(#s11d-col)" stroke="#5A6478" stroke-width="1.3">
      <rect x="16" y="26" width="6" height="22" rx="1.6"/>
      <rect x="29" y="26" width="6" height="22" rx="1.6"/>
      <rect x="42" y="26" width="6" height="22" rx="1.6"/>
    </g>
    <rect x="10" y="48" width="44" height="5" rx="2" fill="url(#s11d-lintel)" stroke="#5A6478" stroke-width="1.4"/>
    <ellipse cx="24" cy="15.5" rx="6" ry="1.6" fill="#fff" opacity=".5" transform="rotate(-16 24 15.5)"/>
    <circle cx="32" cy="17" r="2" fill="#E2B45E"/>`,
    `<linearGradient id="s11d-roof" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#FDFEFF"/><stop offset="1" stop-color="#C6D2E0"/></linearGradient>
    <linearGradient id="s11d-lintel" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#E8EEF5"/><stop offset="1" stop-color="#B8C6D6"/></linearGradient>
    <linearGradient id="s11d-col" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#FDFEFF"/><stop offset=".5" stop-color="#DEE6EF"/><stop offset="1" stop-color="#C0CCDC"/></linearGradient>`,
  ),
  socStepsDeco: S(
    `${shadow(32, 58, 19, 0.12)}
    <rect x="10" y="46" width="44" height="9" rx="2.4" fill="url(#s11d-st1)" stroke="#6E4610" stroke-width="1.5"/>
    <rect x="17" y="36" width="30" height="10" rx="2.2" fill="url(#s11d-st2)" stroke="#6E4610" stroke-width="1.5"/>
    <rect x="24" y="26" width="16" height="10" rx="2" fill="url(#s11d-st3)" stroke="#6E4610" stroke-width="1.5"/>
    <path d="M32 26v-8" stroke="#8C5A16" stroke-width="1.8" stroke-linecap="round"/>
    <path d="M32 18q6-2 8 1-4 3-8 1z" fill="url(#s11d-flag)" stroke="#6E4610" stroke-width="1.3" stroke-linejoin="round"/>
    <ellipse cx="20" cy="48" rx="7" ry="1.5" fill="#fff" opacity=".4"/>
    <ellipse cx="30" cy="28" rx="4.6" ry="1.2" fill="#fff" opacity=".45"/>
    <path d="M14 20l1.2 2.6 2.6 1.1-2.6 1.1-1.2 2.6-1.2-2.6-2.6-1.1 2.6-1.1z" fill="#F2C24E"/>`,
    `<linearGradient id="s11d-st1" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#F0E2CC" /><stop offset="1" stop-color="#D8BE94"/></linearGradient>
    <linearGradient id="s11d-st2" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#E8CFA0"/><stop offset="1" stop-color="#C8A360"/></linearGradient>
    <linearGradient id="s11d-st3" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#D8A848"/><stop offset="1" stop-color="#A8781E"/></linearGradient>
  ...
  scrollDeco: S(
    `${shadow(32, 56, 16, 0.12)}
    <path d="M12 18 h34 v30 h-34 z" fill="url(#hi1-parch)" stroke="#8A6A3E" stroke-width="1.8" stroke-linejoin="round"/>
    <path d="M17 26 h24 M17 32 h24 M17 38 h16" stroke="#B99B66" stroke-width="1.8" stroke-linecap="round" opacity=".8"/>
    <rect x="8" y="12" width="42" height="9" rx="4.5" fill="url(#hi1-roll)" stroke="#6E4E26" stroke-width="1.6"/>
    <rect x="8" y="45" width="42" height="9" rx="4.5" fill="url(#hi1-roll)" stroke="#6E4E26" stroke-width="1.6"/>
    <circle cx="52" cy="16.5" r="3" fill="#8A6034"/><circle cx="52" cy="49.5" r="3" fill="#8A6034"/>
    <ellipse cx="20" cy="15" rx="7" ry="1.8" fill="#fff" opacity=".4"/>`,
    `<linearGradient id="hi1-parch" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#FBF3DC"/><stop offset=".6" stop-color="#F0DFB4"/><stop offset="1" stop-color="#DCC48E"/></linearGradient>
    <linearGradient id="hi1-roll" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#C89A5E"/><stop offset=".55" stop-color="#A87A3E"/><stop offset="1" stop-color="#84582A"/></linearGradient>`,
  ),
  magnifyDeco: S(
    `${shadow(30, 57, 14, 0.12)}
    <circle cx="27" cy="26" r="15" fill="url(#hi1-glass)" stroke="#8A6A3E" stroke-width="3"/>
    <circle cx="27" cy="26" r="15" fill="none" stroke="#5E4626" stroke-width="1.2" opacity=".5"/>
    <path d="M19 19 q4 -5 10 -4" fill="none" stroke="#fff" stroke-width="2.4" stroke-linecap="round" opacity=".75"/>
    <path d="M38 38 l10 11" stroke="#6E4E26" stroke-width="6.5" stroke-linecap="round"/>
    <path d="M38 38 l10 11" stroke="url(#hi1-hand)" stroke-width="4" stroke-linecap="round"/>
    <ellipse cx="22" cy="31" rx="5" ry="2" fill="#fff" opacity=".3" transform="rotate(-30 22 31)"/>`,
    `<radialGradient id="hi1-glass" cx=".38" cy=".3" r="1"><stop offset="0" stop-color="#EAF6FA"/><stop offset=".7" stop-color="#BFE0EC"/><stop offset="1" stop-color="#93C2D6"/></radialGradient>
    <linearGradient id="hi1-hand" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#C89A5E"/><stop offset="1" stop-color="#8A5E2E"/></linearGradient>`,
  ),
  inkbrushDeco: S(
    `${shadow(32, 57, 14, 0.12)}
    <path d="M14 50 q14 -6 34 -4" stroke="url(#hi1-ink)" stroke-width="5" stroke-linecap="round" opacity=".85"/>
    <g transform="rotate(24 34 28)">
      <rect x="31" y="4" width="6" height="30" rx="3" fill="url(#hi1-bam)" stroke="#6E4E26" stroke-width="1.4"/>
      <path d="M31 12 h6 M31 20 h6" stroke="#8A6534" stroke-width="1.2" opacity=".7"/>
      <path d="M30.5 34 h7 l1.5 4 h-10 z" fill="#C8B48A" stroke="#8A6A3E" stroke-width="1.2"/>
      <path d="M31 38 q3 1 6 0 l-2.4 10 q-.6 2 -1.2 0 z" fill="url(#hi1-tip)" stroke="#141C26" stroke-width="1"/>
    </g>
    <ellipse cx="33" cy="10" rx="2.4" ry="1.2" fill="#fff" opacity=".5" transform="rotate(24 33 10)"/>`,
    `<linearGradient id="hi1-ink" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#39424E"/><stop offset="1" stop-color="#141C26"/></linearGradient>
    <linearGradient id="hi1-bam" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#E8C88E"/><stop offset=".55" stop-color="#C89A5E"/><stop offset="1" stop-color="#9E7438"/></linearGradient>
    <linearGradient id="hi1-tip" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#4E5866"/><stop offset="1" stop-color="#10161E"/></linearGradient>`,
  ),
  hourglassDeco: S(
    `${shadow(32, 57, 14, 0.13)}
    <rect x="16" y="8" width="32" height="6" rx="3" fill="url(#hi1-wood)" stroke="#5E4626" stroke-width="1.6"/>
    <rect x="16" y="50" width="32" height="6" rx="3" fill="url(#hi1-wood)" stroke="#5E4626" stroke-width="1.6"/>
    <path d="M20 14 h24 q-2 12 -10 17 q-2 1 0 2 q8 5 10 17 h-24 q2 -12 10 -17 q2 -1 0 -2 q-8 -5 -10 -17 z" fill="url(#hi1-hgl)" stroke="#7A93A6" stroke-width="1.6" stroke-linejoin="round"/>
    <path d="M24 16 h16 q-2 8 -8 12 q-6 -4 -8 -12 z" fill="url(#hi1-sand)"/>
    <path d="M26 48 h12 q-1.5 -7 -6 -10 q-4.5 3 -6 10 z" fill="url(#hi1-sand)"/>
    <path d="M32 33 v10" stroke="#E0B25E" stroke-width="1.8" stroke-linecap="round" stroke-dasharray="1.5 2.4"/>
    <ellipse cx="26" cy="20" rx="3.4" ry="1.6" fill="#fff" opacity=".55" transform="rotate(-24 26 20)"/>`,
    `<linearGradient id="hi1-wood" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#C89A5E"/><stop offset=".55" stop-color="#A87A3E"/><stop offset="1" stop-color="#84582A"/></linearGradient>
    <radialGradient id="hi1-hgl" cx=".36" cy=".3" r="1.1"><stop offset="0" stop-color="#F2FAFD" stop-opacity=".9"/><stop offset=".65" stop-color="#D6E8F2" stop-opacity=".75"/><stop offset="1" stop-color="#AECBDC" stop-opacity=".8"/></radialGradient>
    <linearGradient id="hi1-sand" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#F2CE86"/><stop offset="1" stop-color="#D8A343"/></linearGradient>`,
  ),
  relicjarDeco: S(
    `${shadow(32, 57, 13, 0.13)}
    <path d="M22 12 q10 4 20 0 q4 14 -1 26 q-3 9 -9 14 q-6 -5 -9 -14 q-5 -12 -1 -26 z" fill="url(#hi1-jar)" stroke="#6E4626" stroke-width="1.8" stroke-linejoin="round"/>
    <path d="M22 12 q10 4 20 0" fill="none" stroke="#6E4626" stroke-width="1.6"/>
    <path d="M23 22 l5 5 M28 21 l5 5 M33 21 l5 5 M38 21 l4 4 M24 32 l5 5 M29 31 l5 5 M34 31 l5 5" stroke="#7A4E28" stroke-width="1.4" stroke-linecap="round" opacity=".75"/>
    <path d="M25 44 l4 4 M30 44 l4 4 M35 43 l3.4 3.4" stroke="#7A4E28" stroke-width="1.3" stroke-linecap="round" opacity=".6"/>
  ...
  // ── 역사 Ⅲ. 세계 종교 — "믿음의 길" 세트(석굴→당삼채 낙타→초승달 등불→모자이크→첨탑) ──
  grottoDeco: S(
    `${shadow(32, 57, 16, 0.13)}
    <path d="M12 55 v-26 q0 -20 20 -20 q20 0 20 20 v26 z" fill="url(#hi3-rock)" stroke="#5E4A36" stroke-width="1.8" stroke-linejoin="round"/>
    <path d="M19 55 v-20 q0 -14 13 -14 q13 0 13 14 v20 z" fill="url(#hi3-cave)" stroke="#4A3826" stroke-width="1.5"/>
    <circle cx="32" cy="33" r="4.6" fill="#E8C48A" stroke="#8A6534" stroke-width="1.3"/>
    <path d="M25 50 q0 -10 7 -10 q7 0 7 10 z" fill="#E8C48A" stroke="#8A6534" stroke-width="1.3" stroke-linejoin="round"/>
    <path d="M24 26 q8 -5 16 0" stroke="#8A7050" stroke-width="1.2" fill="none" opacity=".6"/>
    <ellipse cx="22" cy="14" rx="5" ry="2" fill="#fff" opacity=".35" transform="rotate(-24 22 14)"/>`,
    `<linearGradient id="hi3-rock" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#C9B394"/><stop offset=".55" stop-color="#A08662"/><stop offset="1" stop-color="#78603F"/></linearGradient>
    <linearGradient id="hi3-cave" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#6E583E"/><stop offset="1" stop-color="#41301E"/></linearGradient>`,
  ),
  camelDeco: S(
    `${shadow(32, 57, 17, 0.13)}
    <path d="M14 52 l2 -12 q1 -6 6 -7 q2 -6 7 -6 q3 0 4 3 q1 -3 4 -3 q5 0 7 6 q5 1 6 8 l2 11 h-5 l-2 -9 q-6 4 -12 4 q-6 0 -12 -4 l-2 9 z" fill="url(#hi3-sancai)" stroke="#6E4626" stroke-width="1.8" stroke-linejoin="round"/>
    <path d="M20 30 q-4 -2 -4 -8 q0 -5 4 -7 q3 -1.6 4 1 l1 3" fill="url(#hi3-sancai)" stroke="#6E4626" stroke-width="1.8" stroke-linejoin="round"/>
    <circle cx="21" cy="16" r="1.2" fill="#4A3010"/>
    <path d="M26 36 q6 5 12 0 l-1 5 q-5 3 -10 0 z" fill="#4E8E6E" opacity=".85"/>
    <path d="M29 27 q3 2 6 0" stroke="#3FA36E" stroke-width="2.2" stroke-linecap="round" opacity=".8"/>
    <ellipse cx="26" cy="24" rx="3.4" ry="1.4" fill="#fff" opacity=".4"/>`,
    `<linearGradient id="hi3-sancai" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#F0DCB0"/><stop offset=".5" stop-color="#D8A25E"/><stop offset="1" stop-color="#A86A2E"/></linearGradient>`,
  ),
  lanternDeco: S(
    `${shadow(32, 58, 12, 0.13)}
    <path d="M40 10 a9 9 0 1 0 4 17 a7.4 7.4 0 1 1 -4 -17 z" fill="url(#hi3-moon)" stroke="#B08A2E" stroke-width="1.4" stroke-linejoin="round"/>
    <path d="M28 22 h8 M32 22 v4" stroke="#6E5426" stroke-width="1.6" stroke-linecap="round"/>
    <path d="M26 30 q-4 1 -4 5 l2 14 q1 5 8 5 q7 0 8 -5 l2 -14 q0 -4 -4 -5 q-6 -2 -12 0 z" fill="url(#hi3-lamp)" stroke="#6E5426" stroke-width="1.8" stroke-linejoin="round"/>
    <path d="M24 34 h16 M23 40 h18 M24 46 h16" stroke="#8A6A2E" stroke-width="1.1" opacity=".65"/>
    <path d="M27 30 v22 M32 29 v25 M37 30 v22" stroke="#8A6A2E" stroke-width="1.1" opacity=".5"/>
    <circle cx="32" cy="41" r="4" fill="#FFE8B0" opacity=".9"/>
    <path d="M29 54 q3 3 6 0" stroke="#6E5426" stroke-width="1.6" fill="none" stroke-linecap="round"/>
    <ellipse cx="28" cy="33" rx="3" ry="1.4" fill="#fff" opacity=".5"/>`,
    `<linearGradient id="hi3-moon" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#FFE8B0"/><stop offset="1" stop-color="#E0B45E"/></linearGradient>
    <radialGradient id="hi3-lamp" cx=".4" cy=".35" r=".9"><stop offset="0" stop-color="#FFD98A"/><stop offset=".55" stop-color="#E8A94E"/><stop offset="1" stop-color="#B4762A"/></radialGradient>`,
  ),
  mosaicDeco: S(
    `${shadow(32, 56, 16, 0.13)}
    <path d="M14 16 h36 v32 h-36 z" fill="url(#hi3-gold)" stroke="#8A6A2E" stroke-width="1.8" stroke-linejoin="round" transform="rotate(-4 32 32)"/>
    <g transform="rotate(-4 32 32)" opacity=".92">
      <path d="M18 20 h6 v6 h-6 z M26 20 h6 v6 h-6 z M34 20 h6 v6 h-6 z M42 20 h5 v6 h-5 z" fill="#3D5BC0" stroke="#2A3E86" stroke-width=".9"/>
      <path d="M18 28 h6 v6 h-6 z M42 28 h5 v6 h-5 z" fill="#3FA36E" stroke="#2A7048" stroke-width=".9"/>
      <path d="M26 28 h6 v6 h-6 z M34 28 h6 v6 h-6 z" fill="#F2D9A4" stroke="#B08A2E" stroke-width=".9"/>
      <path d="M18 36 h6 v6 h-6 z M26 36 h6 v6 h-6 z M34 36 h6 v6 h-6 z M42 36 h5 v6 h-5 z" fill="#C0392B" stroke="#84281E" stroke-width=".9"/>
    </g>
    <ellipse cx="22" cy="19" rx="5" ry="1.8" fill="#fff" opacity=".4" transform="rotate(-14 22 19)"/>`,
    `<linearGradient id="hi3-gold" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#F6E2B0"/><stop offset=".55" stop-color="#E0B45E"/><stop offset="1" stop-color="#B0842E"/></linearGradient>`,
  ),
  spireDeco: S(
    `${shadow(32, 58, 14, 0.13)}
    <path d="M32 4 l7 16 v10 h-14 v-10 z" fill="url(#hi3-stone)" stroke="#5E6A7A" stroke-width="1.6" stroke-linejoin="round"/>
    <path d="M32 4 l-7 16 h14 z" fill="url(#hi3-stone2)" stroke="#5E6A7A" stroke-width="1.6" stroke-linejoin="round"/>
    <rect x="20" y="30" width="24" height="26" rx="2" fill="url(#hi3-stone)" stroke="#5E6A7A" stroke-width="1.6"/>
    <circle cx="32" cy="39" r="6.4" fill="url(#hi3-rose)" stroke="#4A5668" stroke-width="1.4"/>
    <path d="M32 33.4 v11.2 M26.6 39 h10.8 M28.2 35.2 l7.6 7.6 M35.8 35.2 l-7.6 7.6" stroke="#F2E6C0" stroke-width="1" opacity=".9"/>
    <path d="M28 56 v-7 q0 -4 4 -4 q4 0 4 4 v7 z" fill="#3D2E60" stroke="#4A5668" stroke-width="1.4"/>
    <ellipse cx="26" cy="33" rx="3.4" ry="1.4" fill="#fff" opacity=".45"/>`,
    `<linearGradient id="hi3-stone" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#E8EEF4"/><stop offset=".6" stop-color="#C4D0DC"/><stop offset="1" stop-color="#9AAABA"/></linearGradient>
    <linearGradient id="hi3-stone2" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#F4F8FC"/><stop offset="1" stop-color="#D0DAE4"/></linearGradient>
    <radialGradient id="hi3-rose" cx=".5" cy=".5" r=".65"><stop offset="0" stop-color="#8A6BFF"/><stop offset=".55" stop-color="#5B4AC0"/><stop offset="1" stop-color="#3D2E86"/></radialGradient>`,
  ),

  // ── 역사 Ⅳ. 교류와 변화 — "교역의 길" 세트(나침반→지폐 꾸러미→범선→향신료 자루→왕관) ──
  luopanDeco: S(
    `${shadow(32, 57, 15, 0.13)}
    <circle cx="32" cy="34" r="21" fill="url(#hi4-luopan)" stroke="#6E4A1E" stroke-width="1.8"/>
    <circle cx="32" cy="34" r="14.5" fill="#FBF3DC" stroke="#8A6534" stroke-width="1.3"/>
    <path d="M32 16 v5 M32 51 v-5 M14 34 h5 M50 34 h-5 M19.5 21.5 l3.4 3.4 M44.5 46.5 l-3.4 -3.4 M44.5 21.5 l-3.4 3.4 M19.5 46.5 l3.4 -3.4" stroke="#8A6534" stroke-width="1.4" stroke-linecap="round"/>
    <path d="M32 22 l4.4 12 l-4.4 -3 l-4.4 3 z" fill="#C0392B" stroke="#84281E" stroke-width="1.1" stroke-linejoin="round"/>
    <path d="M32 46 l-4.4 -12 l4.4 3 l4.4 -3 z" fill="#E4EAF2" stroke="#5E6A7A" stroke-width="1.1" stroke-linejoin="round"/>
    <circle cx="32" cy="34" r="2.4" fill="#33405A"/>
    <ellipse cx="24" cy="22" rx="6" ry="2.4" fill="#fff" opacity=".4" transform="rotate(-30 24 22)"/>`,
    `<radialGradient id="hi4-luopan" cx=".4" cy=".35" r=".9"><stop offset="0" stop-color="#F0DCB0"/><stop offset=".55" stop-color="#D8A25E"/><stop offset="1" stop-color="#A86A2E"/></radialGradient>`,
  ),
  jiaoziDeco: S(
    `${shadow(32, 57, 15, 0.13)}
    <rect x="14" y="26" width="30" height="18" rx="2.4" fill="url(#hi4-bill)" stroke="#5E7A4E" stroke-width="1.5" transform="rotate(-7 29 35)"/>
    <rect x="18" y="22" width="30" height="18" rx="2.4" fill="url(#hi4-bill)" stroke="#5E7A4E" stroke-width="1.5" transform="rotate(4 33 31)"/>
    <rect x="17" y="32" width="32" height="19" rx="2.4" fill="url(#hi4-bill2)" stroke="#5E7A4E" stroke-width="1.6"/>
    <circle cx="33" cy="41.5" r="6" fill="none" stroke="#5E7A4E" stroke-width="1.3"/>
    <path d="M21 37 h6 M39 46 h6" stroke="#5E7A4E" stroke-width="1.3" stroke-linecap="round"/>
    <path d="M26 51 q7 4 14 0" stroke="#8A6534" stroke-width="2.6" fill="none" stroke-linecap="round"/>
    <ellipse cx="24" cy="35" rx="5" ry="1.8" fill="#fff" opacity=".5"/>`,
    `<linearGradient id="hi4-bill" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#E4EED8"/><stop offset="1" stop-color="#C6D8B4"/></linearGradient>
    <linearGradient id="hi4-bill2" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#DCE8CE"/><stop offset=".55" stop-color="#C2D4AC"/><stop offset="1" stop-color="#A4BC8C"/></linearGradient>`,
  ),
  galleonDeco: S(
    `${shadow(32, 58, 17, 0.13)}
    <path d="M12 44 h40 l-7 10 h-26 z" fill="url(#hi4-hull)" stroke="#42280F" stroke-width="1.7" stroke-linejoin="round"/>
    <path d="M12 44 q-3 -4 -1 -8 l5 8 z" fill="#5E3E22" stroke="#42280F" stroke-width="1.4"/>
    <path d="M30 12 v32 M44 20 v24" stroke="#5E3E22" stroke-width="1.8" stroke-linecap="round"/>
    <path d="M30 14 q-12 6 -12 15 q6 -3 12 -1 z" fill="url(#hi4-sail)" stroke="#8A7A56" stroke-width="1.4" stroke-linejoin="round"/>
    <path d="M30 14 q13 7 13 16 q-7 -3 -13 -2 z" fill="url(#hi4-sail)" stroke="#8A7A56" stroke-width="1.4" stroke-linejoin="round"/>
    <path d="M44 22 q9 5 9 12 q-5 -2 -9 -1 z" fill="url(#hi4-sail)" stroke="#8A7A56" stroke-width="1.3" stroke-linejoin="round"/>
    <path d="M30 12 l7 2.6 -7 2.6 z" fill="#C0392B"/>
    <path d="M8 54 q6 -4 12 0 q6 4 12 0 q6 -4 12 0 q6 4 12 0" stroke="#4E7694" stroke-width="2.2" fill="none" stroke-linecap="round" opacity=".8"/>
    <ellipse cx="22" cy="46" rx="6" ry="1.8" fill="#fff" opacity=".3"/>`,
    `<linearGradient id="hi4-hull" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#8A6034"/><stop offset=".55" stop-color="#6E4A26"/><stop offset="1" stop-color="#4A2E12"/></linearGradient>
    <linearGradient id="hi4-sail" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#FFFDF6"/><stop offset=".6" stop-color="#EFE6D2"/><stop offset="1" stop-color="#D4C8AC"/></linearGradient>`,
  ),
  spiceDeco: S(
    `${shadow(32, 57, 16, 0.13)}
    <path d="M16 30 q0 -8 8 -9 q8 -8 16 0 q8 1 8 9 l-2 18 q-1 8 -14 8 q-13 0 -14 -8 z" fill="url(#hi4-sack)" stroke="#6E4A26" stroke-width="1.8" stroke-linejoin="round"/>
    <path d="M22 24 q10 -5 20 0" stroke="#6E4A26" stroke-width="1.5" fill="none"/>
    <path d="M24 21 l-2 -6 M32 19 v-6 M40 21 l2 -6" stroke="#8A6034" stroke-width="1.8" stroke-linecap="round"/>
    <path d="M20 30 q12 6 24 0" stroke="#8A6034" stroke-width="1.3" fill="none" opacity=".7"/>
    <ellipse cx="32" cy="27" rx="10" ry="4" fill="url(#hi4-spice)" stroke="#84281E" stroke-width="1.2"/>
    <circle cx="27" cy="26" r="1.3" fill="#84281E"/><circle cx="33" cy="28" r="1.3" fill="#A83220"/><circle cx="38" cy="26" r="1.3" fill="#84281E"/>
    <circle cx="49" cy="44" r="1.6" fill="#C0392B"/><circle cx="52" cy="49" r="1.3" fill="#C0392B"/>
    <ellipse cx="23" cy="33" rx="4" ry="1.6" fill="#fff" opacity=".35"/>`,
    `<linearGradient id="hi4-sack" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#E8D0A4"/><stop offset=".55" stop-color="#C9A870"/><stop offset="1" stop-color="#9A7A44"/></linearGradient>
    <linearGradient id="hi4-spice" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#E86A50"/><stop offset="1" stop-color="#B43A2A"/></linearGradient>`,
  ),
  crownDeco: S(
    `${shadow(32, 56, 15, 0.13)}
    <path d="M15 26 l7 9 l10 -13 l10 13 l7 -9 l-3 22 h-28 z" fill="url(#hi4-crown)" stroke="#8A6218" stroke-width="1.8" stroke-linejoin="round"/>
    <rect x="17" y="46" width="30" height="7" rx="3" fill="url(#hi4-crownband)" stroke="#8A6218" stroke-width="1.6"/>
    <circle cx="15" cy="25" r="2.6" fill="#FFE8B0" stroke="#8A6218" stroke-width="1.2"/>
    <circle cx="32" cy="21" r="2.8" fill="#FFE8B0" stroke="#8A6218" stroke-width="1.2"/>
    <circle cx="49" cy="25" r="2.6" fill="#FFE8B0" stroke="#8A6218" stroke-width="1.2"/>
    <circle cx="25" cy="42" r="2.2" fill="#C0392B" stroke="#84281E" stroke-width="1"/>
    <circle cx="32" cy="49.5" r="2" fill="#3D5BC0" stroke="#2A3E86" stroke-width="1"/>
    <circle cx="39" cy="42" r="2.2" fill="#3FA36E" stroke="#2A7048" stroke-width="1"/>
    <ellipse cx="24" cy="30" rx="5" ry="2" fill="#fff" opacity=".5" transform="rotate(-18 24 30)"/>`,
    `<linearGradient id="hi4-crown" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#F6E2B0"/><stop offset=".55" stop-color="#E0B45E"/><stop offset="1" stop-color="#B0842E"/></linearGradient>
    <linearGradient id="hi4-crownband" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#EFCB84"/><stop offset="1" stop-color="#B88A34"/></linearGradient>`,
  ),
};
