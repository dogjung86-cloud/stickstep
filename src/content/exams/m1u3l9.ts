// 중1 수학 Ⅲ. 좌표평면과 그래프: 단원 종합 평가 풀, 레슨 9 정비례와 그래프의 활용 (m1u3e178~m1u3e200).
...
export const POOL_M1U3L9: ExamItem[] = [
  ...
  },
  {
    ...
    lessonId: L,
    type: "mcq",
    prompt: "P파는 초당 10 km, S파는 초당 5 km로 퍼져요. 150 km 떨어진 곳에서 P파 감지 <b>2초 뒤</b> 경보가 전송되었다면, 경보 뒤 S파 도착까지 남은 시간은?",
    options: ["15초", "30초", "13초", "17초", "2초"],
    answer: 2,
    diff: 3,
    explain: "<span class='xh'>정답 풀이</span>150 km까지 P파는 150÷10=15초, S파는 150÷5=30초가 걸려 초기 미동 시간은 30−15=15초예요. 그러나 경보가 P파 감지 2초 뒤에 전송되었으므로 실제로 남은 시간은 15−2=<b>13초</b>예요.<span class='xh'>오답 하나씩 격파</span>'15초'는 전송 지연을 빼지 않은 값이고, '30초'는 S파의 전체 도착 시간이에요. '17초'는 지연 2초를 더했고, '2초'는 경보 처리 시간만 답했어요. 기준 시점을 P파 도착과 경보 전송 중 어느 것으로 잡는지 끝까지 구분해야 해요.",
    core: "초기 미동 15초에서 경보 지연 2초를 빼면 13초가 남아요.",
  },
  {
    id: "m1u3e195",
    lessonId: L,
    type: "num",
    prompt: "급수 장치가 1초에 <b>2.5 L</b>씩 일정하게 물을 보내요. 450 L를 보내는 데 걸리는 시간을 쓰세요. (단위: 분)",
    answer: "3",
    numKind: "int",
    unitLabel: "분",
    diff: 3,
  ...
  },
  {
    ...
    lessonId: L,
    type: "mcq",
    prompt: "전동 카트가 시속 <b>7.5 km</b>로 일정하게 0.4시간 움직였어요. 계산과 상황 검산을 모두 옳게 한 것은?",
    options: [
