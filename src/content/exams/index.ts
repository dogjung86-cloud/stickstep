...
const EXAMS: Record<string, ExamDef> = {
  ...
  g2u6: G2U6_EXAM, // 신규 출제 v2 — 160제 = 27×4+26×2(num 0 · word 0, g2u6.ts 헤더 참조)
  g2u7: G2U7_EXAM,
  g2u8: G2U8_EXAM,
  ...
  s1u2: S1U2_EXAM, // 사회 시험 2호 160제 — 20×8 균등, s1u1 v1 규격 계승(s1u2.ts 헤더 참조)
};
