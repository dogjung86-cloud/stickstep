...
export const POOL_M1U2L5: ExamItem[] = [
  ...
  },
  {
    ...
    lessonId: L,
    type: "mcq",
    prompt: "스포츠 장비 정리식을 나타낸 4(3<i class='mv'>r</i>−2)−(5<i class='mv'>r</i>+6)을 간단히 한 것은?",
  ...
  },
  {
    ...
    lessonId: L,
    type: "num",
    prompt: "전시 조명 배치식 (7<i class='mv'>r</i>−2)−2(3<i class='mv'>r</i>+5)를 <i class='mv'>a</i><i class='mv'>r</i>+<i class='mv'>b</i>로 정리했어요. <i class='mv'>a</i>+<i class='mv'>b</i>의 값을 구하세요.",
    answer: "-11",
    numKind: "int",
    diff: 2,
    explain:
