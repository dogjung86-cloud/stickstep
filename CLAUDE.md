...
수학 작업 = **MATH_GUIDE.md** · 사회 작업 = **SOC_GUIDE.md** · 역사 작업 = **HIS_GUIDE.md** ·
단원 종합 평가(시험) 작업 = **EXAM_GUIDE.md**를 반드시 함께 읽는다. 본문의 해당 섹션은 최소
요약+포인터만 남았다 — 요약만 보고 트랙·시험 작업에 착수하면 실격. 새 관행 기록도 해당 헌법에.
