...
- **다음 배치 백로그**: Ⅵ 오세아니아와 극지방(soon 등록됨 — continentMap ContinentDef 추가 방식,
  wide 후보), Ⅶ~Ⅻ 일반사회(사례 판단·시나리오 문법 별도 설계), 단원 종합 평가(과학 규격 계승 여부
  결정), "세계 어디게?" 거리 점수 게임(도전 탭 후보 — 탐정 문법은 본선이 아니라 응용).
