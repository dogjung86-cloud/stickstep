...
for (let i = 0; i < ids.length; i++) {
  const want = `g2u2e${String(i + 1).padStart(2, "0")}`;
  const want2 = `g2u2e${i + 1}`;
...
const want = { g2u2l1: 17, g2u2l2: 17, g2u2l3: 17, g2u2l4: 17, g2u2l5: 17, g2u2l6: 17, g2u2l7: 16, g2u2l8: 16, g2u2l9: 16 };
